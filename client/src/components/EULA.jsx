    ...
    >
      ...
      {loading ? (
        ...
        <div ref={wrapper} className="body p-2 fade-in">
          ...
          <h1 className="p-top-1">Interpretation and Definitions</h1>
          ...
          <h2 className="p-top-1">Definitions</h2>
          <p>For the purposes of this End-User License Agreement:</p>
          <div className="p-left-1">
            <ul>
              <li>
                <p>
                  <strong>Agreement</strong> means this End-User License
                  Agreement that forms the entire agreement between You and the
              ...
              <li>
                <p>
                  ...
                  provided by the Company downloaded by You to a Device, named
                  RadishApp
                </p>
              </li>
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to CauseAxis, Inc.,
              ...
              <li>
                <p>
                  ...
                  Application such as a computer, a cellphone or a digital
                  tablet.
                </p>
              </li>
              <li>
              ...
              <li>
                <p>
                  ...
                  the Application or the company, or other legal entity on
          ...
          <h1 className="p-top-1">Acknowledgment</h1>
          <p>
          ...
          <h1 className="p-top-1">License</h1>
          ...
          <h2 className="p-top-1">License Restrictions</h2>
          ...
          <h1 className="p-top-1">Content</h1>
          ...
          <p className="p-top-1">
            ...
            and complies with this Agreement, refuse or remove any Content. The
          ...
          <h1 className="p-top-1">Intellectual Property</h1>
          <p>
          ...
          <h1 className="p-top-1">Your Suggestions</h1>
          <p>
            Any feedback, comments, ideas, improvements or suggestions provided
            by You to the Company with respect to the Application shall remain
          ...
          <h1 className="p-top-1">Modifications to the Application</h1>
          <p>
          ...
          <h2 className="p-top-1">Updates to the Application</h2>
          <p>
          ...
          <h2 className="p-top-1">Maintenance and Support</h2>
          <p>
          ...
          <h1 className="p-top-1">Third-Party Services</h1>
          <p>
          ...
          <h1 className="p-top-1">Term and Termination</h1>
          <p>
          ...
          <h1 className="p-top-1">Indemnification</h1>
          <p>
          ...
          <h1 className="p-top-1">No Warranties</h1>
          <p>
          ...
          <h1 className="p-top-1">Limitation of Liability</h1>
          <p>
          ...
          <h1 className="p-top-1">Severability and Waiver</h1>
          <h2>Severability</h2>
          <p>
          ...
          <h2 className="p-top-1">Waiver</h2>
          <p>
          ...
          <h1 className="p-top-1">Product Claims</h1>
          <p>
            The Company does not make any warranties concerning the Application.
          </p>
          <h1 className="p-top-1">United States Legal Compliance</h1>
          <p>
          ...
          <h1 className="p-top-1">Changes to this Agreement</h1>
          <p>
          ...
          <h1 className="p-top-1">Governing Law</h1>
          <p>
          ...
          <h1 className="p-top-1">Entire Agreement</h1>
          <p>
          ...
          <h1 className="p-top-1">Contact Us</h1>
          <p>
          ...
          <div className="p-left-1">
            <ul>
              <li>
                <p>By email: support@radishapp.io</p>
              </li>
              <li>
                <p>
                  By mail: Attn: Compliance Officer, CauseAxis, Inc. 1680
