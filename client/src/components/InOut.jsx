...
import teamchat from "../graphics/Teams-16x16.png";
          ...
          <table class="table-2">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="td_contact">
                <a class="contact_anchor"
                    target="tbakerchat"
                    href="https://teams.microsoft.com/l/chat/0/0?users=bakert@mirkinc.us"
                  >
                    <img src={teamchat} className="radish-icon-medium" alt="radish" />
                  </a>
                  <a class="contact_anchor" href="tel:330-641-2303">330-641-2303</a>
                  <a class="contact_anchor" href="mailto:bakert@mirkinc.us">mail</a>
                </td>
                <td>
                  Out Until 12/5
                </td>
